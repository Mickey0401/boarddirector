...
from .views import MainView, ContactView, PricingView, DomainView, \
    ...
    CalendarConnectionView, CalendarDisconnectView, CalendarSettingView, ForbiddenView, \
...
urlpatterns += [
    ...
    url(r'^feedback/', TemplateView.as_view(template_name='help_feedback.html'), name='help_feedback'),
    ...
    url(r'^forbidden/(?P<reason>[^/]+)?$', ForbiddenView.as_view(), name='forbidden'),
    ...
    url(r'^(?P<url>[^/]+)/discussions/', include('discussion.urls', namespace='discussion')),
]
