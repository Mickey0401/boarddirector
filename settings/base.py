...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'common.context_processors.zoho',
...
MIDDLEWARE = (
    ...
    'two_factor.middleware.threadlocals.ThreadLocals',  # django-two-factor-auth
)
...
SOCIAL_AUTH_PIPELINE = [
    ...
    # just add 'from-social-login' data field to session
    'registration.social.set_social_login_flag',
...
# if True, then 2FA option will force users to setup and use 2FA
T2FA_ALLOW_ENFORCED = True
# if True, then all users configuration will be removed after 2FA disabled for the account
T2FA_CLEAR_USER_CONFIGS = True

TWO_FACTOR_TOTP_DIGITS = 6
#TWO_FACTOR_SMS_GATEWAY = "two_factor.gateways.twilio.gateway.Twilio"
TWO_FACTOR_SMS_GATEWAY = "registration.two_factor_gateway.Twilio"  # customized SMS
TWILIO_MESSAGE_STRING = "Your verification code is %s"

TWILIO_CALLER_ID = "+00000000000"
TWILIO_ACCOUNT_SID = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
TWILIO_AUTH_TOKEN = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'

STREAM_APP_ID = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'

ZOHO_SALESIQ_WIDGET = False  # "xxxxxxxxxxxxxxxxxxxxxx" (put widget code to enable, None/False to disable)
ZOHO_DESK_WIDGET = True
